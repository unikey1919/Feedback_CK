...
public class DeleteClassDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.delete_class_dialog,null);
    ...
    public void onClassEvent1(Class cl) {
