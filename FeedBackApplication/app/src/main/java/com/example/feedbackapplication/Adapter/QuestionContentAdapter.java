...
public class QuestionContentAdapter extends RecyclerView.Adapter<QuestionContentAdapter.SubItemViewHolder> {

    private List<QuestionContent> subItemList;

    QuestionContentAdapter(List<QuestionContent> subItemList) {
